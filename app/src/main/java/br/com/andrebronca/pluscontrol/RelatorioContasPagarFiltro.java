...
public class RelatorioContasPagarFiltro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_contas_pagar_filtro);
        ...
        btnExibir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (periodoValido()) {
                    intent = new Intent(RelatorioContasPagarFiltro.this, RelatorioContasPagar.class);
                    ...
                    params.putString("sql_contas", getSqlContasPagar());
                    intent.putExtras(params);
                    startActivity(intent);
                } else {
                    Util.exibeMensagem(RelatorioContasPagarFiltro.this, "Data inicial deve ser menor ou igual\n a data final!");
                }
            }
        });
    }
    ...
    private void linkToXml() {
        ...
        btnDataFim = (Button) findViewById(R.id.btn_contas_pagar_data_fim);
        ...
        tvDtNova = (TextView) findViewById(R.id.tv_rel_contas_pagar_dt_nova);
    }
    ...
    /**
     * O objetivo é trazer a data mais antiga ou nova de um título
     *
     * @param dtAntiga
     * @return
     */
    private String getSqlTituloDataVencimentoEmissaoByTipo(boolean dtAntiga) {
        ...
        sb.append(" where tp_natureza = 'D' and dt_baixa = '--' ");
...
//        long dtFim = Util.convertDataParaNumero(diaFim, mesFim, anoFim);
     ...
     * @return
     */
    private String getSqlContasPagar() {
        ...
        sql.append("   and t.tp_natureza = 'D' ");
        if (dataIniSelecionada && dataFimSelecionada) {
    ...
    /*
    select t.id_titulo, t.id_parcela, t.ds_titulo, t.dt_vencimento,
t.vl_saldo, c.ds_categoria, p.nm_pessoa
from titulo as t
inner join categoria as c using(id_categoria)
inner join pessoa as p using(id_pessoa)
where dt_baixa is null
and tp_natureza = 'D'
and dt_vencimento between '2016-09-01' and '2016-10-30'
