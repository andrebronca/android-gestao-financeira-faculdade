...
public class DespesaLista extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_despesa_lista);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(DespesaLista.this, DespesaAdicionar.class);
                startActivity(intent);
            }
        });
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //todo: só listar as categorias que estiverem ativas
        //todo: só listar os fornecedores que estiverem ativos

        tituloDAO = TituloDAO.getInstance(this);
        listaTitulo = (ArrayList<Titulo>) tituloDAO.listaTituloDespesaDescricao();
...
//                        new ArrayAdapter<Titulo>(DespesaLista.this,
//                                android.R.layout.simple_list_item_1, listaTituloPesquisado));
                tituloAdapter = new TituloAdapter(DespesaLista.this, listaTituloPesquisado);
        ...
        edtPesquisa.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    Util.hideKeyboard(DespesaLista.this, edtPesquisa);
                }
            }
        });
            ...
            public void onClick(View v) {
                if (!dataVencIniSelecionado || dataVencFimSelecionado) {
                    if (dataFimMaiorIgualDataIni()) {
                        TituloDAO titDao = TituloDAO.getInstance(DespesaLista.this);
                        listaTituloPeriodo = (ArrayList<Titulo>) titDao.getTituloBySQL(getSqlPeriodoVenc(), null);
//                        listViewTitulos.setAdapter(
//                                new ArrayAdapter<Titulo>( DespesaLista.this,
//                                        android.R.layout.simple_list_item_1,
//                                        listaTituloPeriodo));
                        tituloAdapter = new TituloAdapter(DespesaLista.this, listaTituloPeriodo);
                        listViewTitulos.setAdapter(tituloAdapter);
                        listViewTitulos.setCacheColorHint(Color.TRANSPARENT);
                    } else {
                        Util.exibeMensagem(DespesaLista.this, "Data final deve ser \nigual ou superior a data inicial!");
                    }
                } else {
                    Util.exibeMensagem(DespesaLista.this, "Deve ter um período selecionado!");
                }
        ...
        listViewTitulos.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(DespesaLista.this, DespesaDetalhes.class);
                Titulo titulo = (Titulo) listViewTitulos.getItemAtPosition(position);
    ...
    private void linkToXml() {
        edtPesquisa = (EditText) findViewById(R.id.edt_despesa_pesquisar_lista);
        btnLimparPesquisa = (Button) findViewById(R.id.btn_despesa_lista_limpar);
        listViewTitulos = (ListView) findViewById(R.id.ltv_despesa_lista);
        btnVencDataFim = (Button) findViewById(R.id.btn_despesa_data_final_vencimento);
        btnVencDataIni = (Button) findViewById(R.id.btn_despesa_data_inicial_vencimento);
        btnPesquisarPeriodo = (Button) findViewById(R.id.btn_despesa_periodo);
    }
...
//                            android.R.layout.simple_list_item_1, listaTitulo));
            tituloAdapter = new TituloAdapter(DespesaLista.this, listaTitulo);
            listViewTitulos.setAdapter(tituloAdapter);
            listViewTitulos.setCacheColorHint(Color.TRANSPARENT);
            pesquisar();
        }
