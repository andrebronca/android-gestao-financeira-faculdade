...
public class FornecedorAdicionar extends AppCompatActivity {
    private EditText edtNome, edtEmail;
    private Button btnSalvar, btnCancelar;
    private ToggleButton tgbAtivo;
    private CheckBox cbxTipoFornecedor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtNome.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    Util.hideKeyboard(FornecedorAdicionar.this, edtNome);
                }
            }
        });
        ...
        edtEmail.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (!hasFocus) {
                    Util.hideKeyboard(FornecedorAdicionar.this, edtEmail);
                }
            }
        });
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validarCampos()) {
                    pessoaDAO = PessoaDAO.getInstance(FornecedorAdicionar.this, "FornecedorAdicionar_btnSalvar()");
    ...
    private void linkToXml() {
        edtNome = (EditText) findViewById(R.id.edt_fornecedor_nm_pessoa);
        edtEmail = (EditText) findViewById(R.id.edt_fornecedor_ds_email);
        btnSalvar = (Button) findViewById(R.id.btn_fornecedor_salvar);
        btnCancelar = (Button) findViewById(R.id.btn_fornecedor_cancelar);
        tgbAtivo = (ToggleButton) findViewById(R.id.tbtn_fornecedor_ativo);
        cbxTipoFornecedor = (CheckBox) findViewById(R.id.cbx_fornecedor_tipo);    //se marcado, gravar no campo: 'A'
    }
    ...
    private void getValorCampos() {
        ...
        tp_pessoa = cbxTipoFornecedor.isChecked() ? "A" : "F";
