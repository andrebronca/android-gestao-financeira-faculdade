...
public class DespesasEditar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_despesas_editar);
        ...
        edtDescricao.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(DespesasEditar.this, edtDescricao);
            }
        });
        //d
        edtValor.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(DespesasEditar.this, edtValor);
            }
        });
        //e
...
//                }
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validarDadosFormulario()) {
                    TituloDAO tituloDAO = TituloDAO.getInstance(DespesasEditar.this);
        ...
        btnExcluir.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(DespesasEditar.this);
                alerta
                        .setTitle("Atenção")
    ...
    private void linkToXml() {
        spnCategoria = (Spinner) findViewById(R.id.spn_despesa_edit_categoria);
        spnPessoa = (Spinner) findViewById(R.id.spn_despesa_edit_pessoa);
        edtDescricao = (EditText) findViewById(R.id.edt_despesa_edit_descricao);
        edtValor = (EditText) findViewById(R.id.edt_despesa_edit_valor);
        edtParcela = (EditText) findViewById(R.id.edt_despesa_edit_parcela);
        cbExibeRelatorio = (CheckBox) findViewById(R.id.cb_despesa_edit_relatorio);
        btnSalvar = (Button) findViewById(R.id.btn_despesa_edit_salvar);
        btnExcluir = (Button) findViewById(R.id.btn_despesa_edit_excluir);
        btnEmissao = (Button) findViewById(R.id.btn_despesa_edit_emissao);
        btnVencimento = (Button) findViewById(R.id.btn_despesa_edit_vencimento);
        tvEmissao = (TextView) findViewById(R.id.lb_despesa_edit_emissao);
        tvVencimento = (TextView) findViewById(R.id.lb_despesa_edit_vencimento);
        tvAjudaValor = (TextView) findViewById(R.id.lb_despesa_edit_valor);
    }

    //2
    private void preencherTitulo() {
        TituloDAO tituloDAO = TituloDAO.getInstance(this);
        PessoaDAO pessoaDAO = PessoaDAO.getInstance(this, "DespesasEditar_preencherTitulo()");
    ...
    private void preencherListaCategoria() {
        ...
        CategoriaDAO categoriaDAO = CategoriaDAO.getInstance(DespesasEditar.this);
        listaCategoria = categoriaDAO.getCategoriaByTipo("D");
        listaCategoria.add(0, getFirstCategoria());
        adapterCategoria = new ArrayAdapter<Categoria>(DespesasEditar.this, android.R.layout.simple_spinner_dropdown_item, listaCategoria);
    ...
    private void preencherListaPessoa() {
        ...
        PessoaDAO pessoaDAO = PessoaDAO.getInstance(DespesasEditar.this, "DespesasEditar_preencheListaPessoa()");
        listaPessoa = pessoaDAO.getListaPessoaFornecedorOrAmbos();
        listaPessoa.add(0, getFirstPessoa());
        adapterPessoa = new ArrayAdapter<Pessoa>(DespesasEditar.this, android.R.layout.simple_spinner_dropdown_item, listaPessoa);
    ...
    private double getValorTitulo() {
        ...
        try {
            vl = Double.parseDouble(edtValor.getText().toString());
...
//            long vencimento = Util.convertDataParaNumero(diaVenc, mesVenc, anoVenc);
    ...
    private void fecharActivity() {
        intent = new Intent(this, DespesaLista.class);
