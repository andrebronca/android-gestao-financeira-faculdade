...
public class PagamentoEditar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagamento_editar);
        ...
        edtHistorico.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(PagamentoEditar.this, edtHistorico);
            }
        });
        ...
        edtValor.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(PagamentoEditar.this, edtValor);
            }
        });
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validarFormulario()) {
                    MovimentoContaDAO movimentoContaDAO = MovimentoContaDAO.getInstance(PagamentoEditar.this);
                    ...
                    Util.exibeMensagem(PagamentoEditar.this, "Movimento salvo com sucesso!");
                    fecharActivity();
                }
            }
        });
        ...
        tvAjudaValor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(PagamentoEditar.this);
    ...
    private void linkToXml() {
        spnConta = (Spinner) findViewById(R.id.spn_pagamento_editar_conta);
        edtValor = (EditText) findViewById(R.id.edt_pagamento_editar_valor);
        edtHistorico = (EditText) findViewById(R.id.edt_pagamento_editar_historico);
        btnDtMovimento = (Button) findViewById(R.id.btn_pagamento_editar_data);
        btnSalvar = (Button) findViewById(R.id.btn_pagamento_editar_salvar);
        btnCancelar = (Button) findViewById(R.id.btn_pagamento_editar_cancelar);
        tvAjudaValor = (TextView) findViewById(R.id.tv_pagamento_editar_valor);
        tvDataEmissao = (TextView) findViewById(R.id.tv_pagamento_data_emissao);
        tvDataVencimento = (TextView) findViewById(R.id.tv_pagamento_data_vencimento);
    }
    ...
    private void getTituloByIdParcela() {
        ...
        objTitulo = tituloDAO.getTituloByID(idTitulo, idParcela);
    ...
    private void fecharActivity() {
        intent = new Intent(PagamentoEditar.this, PagamentoLista.class);
    ...
    private Titulo getTituloComSaldoAtualizado() {
        TituloDAO tituloDAO = TituloDAO.getInstance(this);
        Titulo tituloTmp = tituloDAO.getTituloByID(idTitulo, idParcela);
        double saldo_original = tituloTmp.getVlSaldo();
        Titulo titulo = new Titulo();
        titulo.setIdTitulo(idTitulo);
        titulo.setIdParcela(idParcela);
    ...
    private MovimentoConta getMovimentoConta(Conta conta, Titulo titulo) {
        ...
        movimentoConta.setIdParcela(titulo.getIdTitulo());    //por hora utilizar assim
