...
public class SaqueDetalhes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saque_detalhes);
    ...
    private void linkToXml() {
        tvContaOrigem = (TextView) findViewById(R.id.tv_saque_detalhe_origem);
        tvContaDestino = (TextView) findViewById(R.id.tv_saque_detalhe_destino);
        tvValor = (TextView) findViewById(R.id.tv_saque_detalhe_valor);
        tvData = (TextView) findViewById(R.id.tv_saque_detalhe_data);
    }
