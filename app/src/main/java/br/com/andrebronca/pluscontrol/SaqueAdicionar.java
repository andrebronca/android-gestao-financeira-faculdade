...
public class SaqueAdicionar extends AppCompatActivity {
    ...
    private Button btnDtSaque, btnSalvar, btnCancelar;
    ...
    private final String DIRECAO_ORIGEM = "S", DIRECAO_DESTINO = "E", TIPO = "S", SELECIONE = "--SELECIONE--";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saque_adicionar);
        ...
        edtValor.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(SaqueAdicionar.this, edtValor);
            }
        });
        ...
        edtHistorico.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                Util.hideKeyboard(SaqueAdicionar.this, edtHistorico);
            }
        });

        btnDtSaque.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (validarDados()){
                    MovimentoContaDAO movimentoContaDAO = MovimentoContaDAO.getInstance(SaqueAdicionar.this);
                    ...
                    Util.exibeMensagem(SaqueAdicionar.this,"Saque executado com sucesso!");
                    fecharActivity();
                }
            }
        });
        ...
        tvAjudaValor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder alerta = new AlertDialog.Builder(SaqueAdicionar.this);
    ...
    private void linkToXml(){
        spnContaOrigem = (Spinner) findViewById(R.id.spn_saque_origem);
        spnContaDestino = (Spinner) findViewById(R.id.spn_saque_destino);
        edtValor = (EditText) findViewById(R.id.edt_saque_valor);
        edtHistorico = (EditText) findViewById(R.id.edt_saque_historico);
        btnDtSaque = (Button) findViewById(R.id.btn_saque_data);
        btnSalvar = (Button) findViewById(R.id.btn_saque_salvar);
        btnCancelar = (Button) findViewById(R.id.btn_saque_cancelar);
        tvAjudaValor = (TextView) findViewById(R.id.tv_saque_valor);
        tvSaldoOrigem = (TextView) findViewById(R.id.tv_saque_conta_saldo_origem);
        tvSaldoDestino = (TextView) findViewById(R.id.tv_saque_conta_saldo_destino);
    }
    ...
    private boolean validarDados(){
        ...
        if (!emissSelecionado){
            Util.exibeMensagem(this,"Selecione uma data para o saque!");
            return false;
        } 
        return true;
    }
    ...
    private void fecharActivity(){ //ok
        intent = new Intent(SaqueAdicionar.this, SaqueLista.class);
    ...
    public class DatePickerFragment extends DialogFragment implements DatePickerDialog.OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
            ...
            if (tag.equals("E")){
                ...
                String str = "Sacado em: "+ diaEmiss +"/"+ mesEmiss +"/"+ anoEmiss;
                btnDtSaque.setText(str);
                setDtMovimento();
            }
        }
