...
public class PagamentoDetalhes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagamento_detalhes);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(PagamentoDetalhes.this, PagamentoEditar.class);
    ...
    private void linkToXml() {
        tvCategoria = (TextView) findViewById(R.id.tv_pagamento_detalhe_categoria);
        tvCliente = (TextView) findViewById(R.id.tv_pagamento_detalhe_cliente);
        tvDescricao = (TextView) findViewById(R.id.tv_pagamento_detalhe_titulo);
        tvNatureza = (TextView) findViewById(R.id.tv_pagamento_detalhe_natureza);
        tvEmissao = (TextView) findViewById(R.id.tv_pagamento_detalhe_emissao);
        tvVencimento = (TextView) findViewById(R.id.tv_pagamento_detalhe_vencimento);
        tvVlTitulo = (TextView) findViewById(R.id.tv_pagamento_detalhe_valor);
        tvVlSaldo = (TextView) findViewById(R.id.tv_pagamento_detalhe_saldo);
        tvDtBaixa = (TextView) findViewById(R.id.tv_pagamento_detalhe_baixa);
        tvQtdParcela = (TextView) findViewById(R.id.tv_pagamento_detalhe_qtparcela);
        tvParcela = (TextView) findViewById(R.id.tv_pagamento_detalhe_parcelanr);  //id_parcela
        tvRelatorio = (TextView) findViewById(R.id.tv_pagamento_detalhe_relatorio);
        tvDtCad = (TextView) findViewById(R.id.tv_pagamento_detalhe_cadastro);
        tvDtAlt = (TextView) findViewById(R.id.tv_pagamento_detalhe_alterado);
    }
