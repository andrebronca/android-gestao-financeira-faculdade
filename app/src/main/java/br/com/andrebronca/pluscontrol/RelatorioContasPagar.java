...
public class RelatorioContasPagar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relatorio_contas_pagar);
        ...
        btnExportar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GerarPDF gerarPDF = new GerarPDF(RelatorioContasPagar.this, "ContasPagar", getHtmlToWebView());
    ...
    private void linkToXml() {
        tvPeriodo = (TextView) findViewById(R.id.tv_contas_pagar_cab_periodo);
        btnExportar = (Button) findViewById(R.id.btn_contas_pagar_exportar_pdf);
        webView = (WebView) findViewById(R.id.webview_contas_pagar);
    }
...
//        sb.append("tr:nth-child(even) {background-color: #B0E982}"); //verde
        ...
        sb.append("</head>");
        sb.append("<body>");
        sb.append("<center><h3>Contas a pagar</h3></center>");
