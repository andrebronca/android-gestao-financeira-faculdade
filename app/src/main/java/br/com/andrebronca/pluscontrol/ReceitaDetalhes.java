...
public class ReceitaDetalhes extends AppCompatActivity {
    private Bundle params = new Bundle();
    private int id_titulo, qtdParcelas, id_parcela;
...
//                if (valorIgualSaldo()) {
                if (tituloNaoEditado) {
                    intent = new Intent(ReceitaDetalhes.this, ReceitaEditar.class);
                    params.putInt("id", id_titulo);
                    params.putDouble("saldo", saldoDoTitulo);
                    intent.putExtras(params);
                    startActivity(intent);
                } else {
                    Util.exibeMensagem(ReceitaDetalhes.this, "Título já movimentado. \nNão é possível editar!");
                }
            }
        });
    ...
    private void linkToXml() {
        tvTitulo = (TextView) findViewById(R.id.tv_receita_detalhe_titulo);
        tvNatureza = (TextView) findViewById(R.id.tv_receita_detalhe_natureza);
        tvEmissao = (TextView) findViewById(R.id.tv_receita_detalhe_emissao);
        tvVencimento = (TextView) findViewById(R.id.tv_receita_detalhe_vencimento);
        tvValor = (TextView) findViewById(R.id.tv_receita_detalhe_valor);
        tvSaldo = (TextView) findViewById(R.id.tv_receita_detalhe_saldo);
        tvBaixa = (TextView) findViewById(R.id.tv_receita_detalhe_baixa);
        tvQtParcela = (TextView) findViewById(R.id.tv_receita_detalhe_qtparcela);
        tvRelatorio = (TextView) findViewById(R.id.tv_receita_detalhe_relatorio);
        tvCadastro = (TextView) findViewById(R.id.tv_receita_detalhe_cadastro);
        tvAlterado = (TextView) findViewById(R.id.tv_receita_detalhe_alterado);
        tvCategoria = (TextView) findViewById(R.id.tv_receita_detalhe_categoria);
        tvCliente = (TextView) findViewById(R.id.tv_receita_detalhe_cliente);
    }

    private Titulo getDadosTitulo() {
        tituloDAO = TituloDAO.getInstance(this);
        categoriaDAO = CategoriaDAO.getInstance(this);
        pessoaDAO = PessoaDAO.getInstance(this, "ReceitaDetalhes_getDadosTitulo()");
        titulo = tituloDAO.getTituloByID(id_titulo, id_parcela);
        //qtdParcelas = titulo.getQtParcela();
